                    ...
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            ...
                            case 1:
                                this.createOtherMenu(player, ConstNpc.ORTHER_MENU1,
                                        "Xin chào, sự kiện hè 2023 đang được diễn ra", "Chế Tạo Bồn\n Tắm Gỗ",
                                        "Chế Tạo Bồn\n Tắm Vàng", "Từ chối");
                                break;
                            case 2:
                                this.createOtherMenu(player, ConstNpc.ORTHER_MENU2,
                                        "Xin chào, sự kiện hè 2023 đang được diễn ra", "Tặng Bọ\nCánh Cứng",
                                        "Tặng\nNgài Đêm", "Từ chối");
                                break;
                        }
                        ...
                        if (rw.template.type == 11) {// đồ đeo lưng
                            ...
                            if (rw.template.id != ConstItem.MANH_AO || rw.template.id != ConstItem.MANH_QUAN
                                ...
                                rw.itemOptions.add(new ItemOption(93, Util.nextInt(1, 3)));
                            }
                        ...
                        sb.append("|2|Chế tạo Bồn Tắm ").append(select == 1 ? "gỗ" : "vàng\n").append("|1|Cành khô: ")
                                ...
                                .append("Que đốt: ")
                                .append(InventoryService.gI().getQuantity(player, ConstItem.QUE_DOT)).append("/2\n");
