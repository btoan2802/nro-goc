...
public class ItemData {
    ...
    public static void updateItem(Session session) {
        ...
        updateItemTemplate(session, 850);
        updateItemTemplate(session, 850, Manager.ITEM_TEMPLATES.size());
    ...
    private static void updateItemArrHead2FTemplate(Session session) {
        Message msg;
        try {
            msg = new Message(-28);
            msg.writer().writeByte(8);
            ...
            for (Item.ArrHead2Frames io : Manager.ARR_HEAD_2_FRAMES) {
