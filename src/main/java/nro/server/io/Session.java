...
//                this.version = 231;
//
////                String key = arrPlatform[1];
////                if (!"d8352c17e9fcb3eabc7c6ed9ab925538_v0.0.1".equals(key)) {
////                    Service.getInstance().sendThongBaoOK(this, "Vui lòng sử dụng phiên bản của nhà phát hành !");
////                    return;
////                }
//
...
//                if (!"d8352c17e9fcb3eabc7c6ed9ab925538_v0.0.1".equals(key)) {
//                    Service.getInstance().sendThongBaoOK(this, "Hãy tải lại phiên bản mới nhất tại trang chủ nhé !");
//                    return
//
//                }
                isSetClientType = true;
    ...
    public boolean canConnectWithIp() {
        ...
        if (o == null) {
            ...
            System.out.println("MAX_PER_IP: " + Manager.MAX_PER_IP);
    ...
    public void login(String username, String password) {
        ...
        if (this.version < 217) {
            Service.getInstance().sendThongBaoOK(this, "Vui lòng sử dụng phiên bản trên 217");
            return;
        }
        logging = true;
...
//        if (this.isAdmin) {
        if (loginSuccess && !joinedGame) {
            player = GodGK.loadPlayer(this);// tải dữ liệu người chơi từ database
            if (!dataLoadFailed) {
                if (player != null) {
                    enter();
                } else {
...
//        } else {
//            Service.getInstance().sendThongBaoOK(this, "May chu dang bao tri");
//            Client.gI().kickSession(this);
//        }
    }
