...
public class MessageSender implements Runnable {
    ...
    public void sendSessionKey() {
        ...
        try {
            ...
            msg.writer().writeUTF(SettingGame.LinkIp);
            msg.writer().writeInt(14446);
            msg.writer().writeBoolean(false);
//            String key = msg.reader().readUTF();
//            if ("d8352c17e9fcb3eabc7c6ed9ab925538".equals(key)) {
            doSendMessage(msg);
//            } else {
//                Service.getInstance().sendThongBaoOK(session, "Vui lòng sử dụng phiên bản của nhà phát hành !");
//            }
            msg.cleanup();
