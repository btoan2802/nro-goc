...
public class RaiTi_TD extends FutureBoss {

    public RaiTi_TD() {
        super(BossFactory.RAITI_TD, BossData.RAITI_TD);
    }
    ...
    public void rewards(Player pl) {
        if (Util.isTrue(1, 4)) {
            ...
            ItemMap itemMap = new ItemMap(this.zone, 188,
                    Util.nextInt(500000000, 1_000_000_000), pl.location.x, this.zone.map.yPhysicInTop(pl.location.x, pl.location.y - 24), pl.id);
            Service.getInstance().dropItemMap(this.zone, itemMap);
        }
