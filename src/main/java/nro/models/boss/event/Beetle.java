...
public class Beetle extends EscortedBoss {
    ...
    public void rewards(Player pl) {
        ItemMap itemMap = new ItemMap(this.zone, ConstItem.NGAI_DEM, 1, this.location.x,
    ...
    public void joinMap() {
        if (escort != null && escort.zone != null) {
            int x = Util.nextInt(100, escort.zone.map.mapWidth - 100);
            ChangeMapService.gI().changeMapBySpaceShip(this, escort.zone, ChangeMapService.NON_SPACE_SHIP, x);
        }
    }
