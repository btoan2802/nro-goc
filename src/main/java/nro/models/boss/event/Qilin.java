...
//            }
//            if (result) {
//                Service.getInstance().chat(plAtt, "Đi thôi Ông già");
//                PlayerService.gI().changeAndSendTypePK(plAtt, ConstPlayer.PK_ALL);
//                setEscort(plAtt);
//            }
////             if(plAtt.isDie()){
////                 stopEscorting();
...
//    }
    ...
    public int injured(Player plAtt, int damage, boolean piercing, boolean isMobAttack) {
        try {
            ...
            if (result) {
                Service.getInstance().chat(plAtt, "Đi thôi nào!");
                setEscort(plAtt);
            }
        }
    }
    ...
    public void initTalk() {
        textTalkMidle = new String[]{"|-1|Phát quà"};
    }
    ...
    public void joinMap() {
        ...
        int x = Util.nextInt(50, this.zone.map.mapWidth);
