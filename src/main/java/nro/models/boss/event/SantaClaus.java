...
public class SantaClaus extends Boss {
    ...
    public void initTalk() {
        textTalkBefore = new String[]{"|-1|Giáng sinh vui vẻ"};
        textTalkMidle = new String[]{"|-1|Hô hô hô", "|-1|Giáng sinh vui vẻ", "|-1|Giáng sinh an lành"};
        textTalkAfter = new String[]{"|-1|Bye bye"};
    }
