 ...
 *
 */
public class TrungUyThepNew extends FutureBoss {

    public TrungUyThepNew() {
        super(BossFactory.TRUNG_UY_THEP_NEW, BossData.TRUNG_UY_THEP_2);
    }
    ...
    public void leaveMap() {
        ...
        ChangeToAttackTogether(BossFactory.ROBOT_VE_SI_NEW);
        super.leaveMap();
