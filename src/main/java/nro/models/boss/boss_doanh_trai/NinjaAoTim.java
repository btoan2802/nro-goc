...
public class NinjaAoTim extends BossDoanhTrai {
    ...
    public NinjaAoTim(short id, BossData bossData, DoanhTrai doanhTrai) {
    ...
    public void initTalk() {
        this.textTalkMidle = new String[]{"|-1|Hahaha..", "|-1|Ngươi nghĩ có thể bắt kịp cựu ninja như ta sao",
            "|-1|Còn chậm lắm nhóc ơi", "|-1|Chịu thua đi..", "|-1|Con già vợ yếu đang chờ ngươi ở nhà kìa!"};
    }
