...
public class S_Bojack extends FutureBoss {

    public S_Bojack() {
        super(BossFactory.S_BOJACK, BossData.S_BOJACK);
    }
    ...
    public void rewards(Player pl) {
        ...
        itemMap = new ItemMap(this.zone, 428, 1, x, y, pl.id);
        itemMap.options.add(new ItemOption(ConstOption.SUC_DANH_PT, Util.nextInt(20, 30)));
        itemMap.options.add(new ItemOption(ConstOption.HP_PT, Util.nextInt(20, 30)));
        itemMap.options.add(new ItemOption(ConstOption.KI_PT, Util.nextInt(20, 30)));
        ...
        if (!generalRewards(pl, (byte) 10, (byte) 10)) {
        }
    }
    ...
    public void leaveMap() {
        super.leaveMap();
        CreatBossLastDie(cFlag, expoff);
        BossFactory.createBossAffterLeaveMap(BossFactory.BOJACK, true);
        BossManager.gI().removeBoss(this);
    }

    protected void effectTroi() {
