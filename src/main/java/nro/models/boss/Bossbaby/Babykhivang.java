package nro.models.boss.Bossbaby;
 ...
 *
 */
public class Babykhivang extends FutureBoss {

    public Babykhivang() {
        super(BossFactory.BABY_KHI_VANG, BossData.BABY_KHI_VANG);
    }
    ...
    public void rewards(Player pl) {
        if (Util.isTrue(100, 100)) {
            this.dropItemReward(1596, (int) pl.id, 1);
        }
    }
