 ...
 *
 */
public class FrankyNew extends FutureBoss {

    public FrankyNew() {
        super(BossFactory.FRANKY_NEW, BossData.FRANKY_NEW);
    }
    ...
    public void rewards(Player pl) {
        try {
            ...
            itemMap = new ItemMap(this.zone, 624, 1, x, y, pl.id);
    ...
    public void leaveMap() {
        ChangeToAttackTogether(BossFactory.USOPP_NEW);
        super.leaveMap();
