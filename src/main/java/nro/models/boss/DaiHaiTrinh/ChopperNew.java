 ...
 *
 */
public class ChopperNew extends FutureBoss {

    public ChopperNew() {
        super(BossFactory.CHOPPER_NEW, BossData.CHOPPER_NEW);
    }
    ...
    public void rewards(Player pl) {
        try {
            ...
            itemMap = new ItemMap(this.zone, 622, 1, x, y, pl.id);
    ...
    public void leaveMap() {
        ChangeToAttackTogether(BossFactory.ROBIN_NEW);
