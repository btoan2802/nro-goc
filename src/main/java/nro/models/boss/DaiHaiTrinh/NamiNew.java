 ...
 *
 */
public class NamiNew extends FutureBoss {

    public NamiNew() {
        super(BossFactory.NAMI_NEW, BossData.NAMI_NEW);
    }
    ...
    public void rewards(Player pl) {
        ...
        try {
            ...
            itemMap = new ItemMap(this.zone, 623, 1, x, y, pl.id);
    ...
    public void leaveMap() {
        ChangeToAttackTogether(BossFactory.SANJI_NEW);
