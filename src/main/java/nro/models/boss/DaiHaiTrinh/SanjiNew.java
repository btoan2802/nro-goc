 ...
 *
 */
public class SanjiNew extends FutureBoss {

    public SanjiNew() {
        super(BossFactory.SANJI_NEW, BossData.SANJI_NEW);
    }
    ...
    public void rewards(Player pl) {
        ...
        try {
            ...
            itemMap = new ItemMap(this.zone, 620, 1, x, y, pl.id);
            itemMap.options.add(new ItemOption(ConstOption.SUC_DANH_PT, 6));
    ...
    public void leaveMap() {
        Boss SuperCheck = BossManager.gI().getBossById(BossFactory.ZORO_NEW);
