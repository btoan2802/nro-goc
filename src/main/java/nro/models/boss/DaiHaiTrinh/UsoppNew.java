 ...
 *
 */
public class UsoppNew extends FutureBoss {

    public UsoppNew() {
        super(BossFactory.USOPP_NEW, BossData.USOPP_NEW);
    }
    ...
    public void rewards(Player pl) {
        ...
        try {
            ...
            itemMap = new ItemMap(this.zone, 625, 1, x, y, pl.id);
    ...
    public void initTalk() {
        this.textTalkMidle = new String[]{
            "|-1|Tuyệt kỹ, ngôi sao xanh.."
        };
    }

    @Override
    public void leaveMap() {
        ChangeToAttackTogether(BossFactory.NAMI_NEW);
        super.leaveMap();
