 ...
 *
 */
public class BrookNew extends FutureBoss {

    public BrookNew() {
        super(BossFactory.BROOK_NEW, BossData.BROOK_NEW);
    }
    ...
    public void rewards(Player pl) {
        try {
            ...
            itemMap = new ItemMap(this.zone, 621, 1, x, y, pl.id);
    ...
    public void leaveMap() {
        ChangeToAttackTogether(BossFactory.CHOPPER_NEW);
