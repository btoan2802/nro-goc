...
public class DoanhTrai {
    ...
    private void finish() {
        ...
        this.clan = null;
        this.isHaveDoneDoanhTrai = false;
        this.doneSendTextAgain = false;
        this.isOpened = false;
    }
    ...
    public void DropNgocRong() {
        for (Zone zone : zones) {
            ...
            switch (zone.map.mapId) {
                case 53:
                    itemMap = new ItemMap(zone, Util.nextInt(17, 20), 2, 960, 384, -1);
                ...
                case 58:
                    ...
                    break;
                case 59:
                    itemMap = new ItemMap(zone, Util.nextInt(17, 20), 2, 675, 240, -1);
                    itemMap.isDoanhTraiBall = true;
                    Service.getInstance().dropItemMap(zone, itemMap);
                    break;
                case 60:
                    ...
                    break;
                case 61:
                    itemMap = new ItemMap(zone, Util.nextInt(17, 20), 2, 789, 264, -1);
                    itemMap.isDoanhTraiBall = true;
                    Service.getInstance().dropItemMap(zone, itemMap);
                    break;
                case 62:
                ...
                case 55:
                    ...
                    break;
                case 56:
                    itemMap = new ItemMap(zone, Util.nextInt(17, 20), 1, 790, 312, -1);
                    itemMap.isDoanhTraiBall = true;
                    Service.getInstance().dropItemMap(zone, itemMap);
                    break;
                case 54:
                    itemMap = new ItemMap(zone, 18, Util.nextInt(1,3), 560, 312, -1);
                    itemMap.isDoanhTraiBall = true;
                    Service.getInstance().dropItemMap(zone, itemMap);
                    break;
            }
