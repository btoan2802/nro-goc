...
public class DaiHoiService {
    ...
    public byte hourToTypeDHVT(int hour) {
        ...
        //System.out.println("dai hoi vo thuat: " + hour);
            ...
            for (int i = 0; i < countMatch; i++) {
                ...
                TimerTask vsDHVT = new TimerTask() {
                    public void run() {
                        ...
                        } else if ((p22 == null || p22.getSession() == null) && p11 != null
                                && p11.getSession() != null) {
                ...
                public void run() {
                    if ((System.currentTimeMillis() - DaiHoiManager.gI().tNextRound) >= 0) {
                        ...
                        if (DaiHoiManager.gI().lstIDPlayers.size() > 1) {
                            ...
                            if (DaiHoiManager.gI().lstIDPlayers.size() == 1) {
                                Client.gI().getPlayer(DaiHoiManager.gI().lstIDPlayers.get(0)).receivedTopDhVT = true;
                                ServerNotify.gI()
                                ...
                                Service.getInstance().sendThongBao(
                                        ...
                                        "Bạn đã vô địch giải đấu, xin chúc mừng bạn, bạn được thưởng cải trang dành riêng cho top, vui lòng nhận quà tại MR Santa");
                            }
                            DaiHoiManager.gI().lstIDPlayers.clear();
                            DaiHoiManager.gI().lstIDPlayers2.clear();
                            DaiHoiManager.gI().openDHVT = false;
