...
public class PartJson {
    ...
    public static final String FILE_PATH = "C:\\Users\\Administrator\\Desktop\\part";// tim duong dan part
    public static final String OUTPUT_FILE_PATH = "C:\\Users\\Administrator\\Desktop\\part.sql";// duong dan save part
    ...
    private static List<PartInfo> readParts(String filePath) {// read part
        ...
        try (DataInputStream dis = new DataInputStream(new FileInputStream(filePath));
                PrintWriter writer = new PrintWriter("arriety.txt")) {// xuất tinh ra text && save du lieu tren cmd ra folder src
    ...
    private static String createSql(List<PartInfo> parts) {
